         ...
         <input type="hidden" name="user_resume_idx" value="${userResume.user_resume_idx}">
            ...
            <div class="input-container">
                <div class="address-container">
                    ...
                    <div class="form-group">
                	<input type="text" name="region_address" id="roadFullAddr" value="${userResume.region_address}" required/>
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea name="user_intro" required>${userResume.user_intro}</textarea>
            </div>

            <div>
                <input type="submit" value="제출" onclick="return validateCheckbox()"/>
            </div>
        </form>
    </main>
