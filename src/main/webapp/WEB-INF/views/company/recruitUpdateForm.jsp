        ...
        <form action="/Company/RecruitUpdate" id="form">
            <div class="input-container">
               ...
               <div id="collaborationTools" class="checkbox-group">
                ...
                <label>모집인원</label>
                <input type="text" placeholder="모집인원" name="getman" value="${ companyOneRecruit.GETMAN }">
                ...
                <label>채용공고기간</label>
                <input type="text" placeholder="채용공고기간" name="application_deadline" value="${ companyOneRecruit.APPLICATION_DEADLINE }">

                <label>회사설립일</label>
                <input type="text" placeholder="회사설립일" name="company_establish" value="${ companyOneRecruit.COMPANY_ESTABLISH }">
